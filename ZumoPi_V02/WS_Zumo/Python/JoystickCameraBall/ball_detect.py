...
class BallDetect:
    ...
    def process_frame(self):
        """
        Captures a frame from the camera, processes it (detects a ball, overlays data, computes FPS),
        and returns the frame as a base64-encoded JPEG string.
        """
        ...
        if circles is not None:
            ...
            for i in circles[0, :]:
                ...
                y_center_corr = self.project_y(BALL_RADIUS_REAL, D_corr, f_y, cy_img)
                ...
                self.draw_centered_text(frame, lines, ball_u, ball_v)
